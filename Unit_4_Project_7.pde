...
//  wall(random(0, 255), random(0, 255), random(0, 255), 0.7);
//  window(50, 100, random(0, 255), random(0, 255), random(0, 255));
//  window(350, 100, random(0, 255), random(0, 255), random(0, 255));
//  roof(random(0, 255), random(0, 255), random(0, 255));
//  door(115, 225, random(0, 255), random(0, 255), random(0, 255));
...
void wave(float y) {
  ...
  while (x <= 1200) {
    pushMatrix();
    translate(x, y);
    fill(red(greyblue), green(greyblue), blue(greyblue + (int)random(1, 15)), random(50, 200));
    stroke(0, 0, 0, random(200, 250));
    strokeWeight(0.7);
    ellipse(x, y, random(7, 17), random(7, 17));
    x = x + 3;
    y = y + random(-4, 4);
    while(y < 3) {
      y = 0;
...
} //Ground -- Sub-Function: wave ends here: =====================================================================================================================
